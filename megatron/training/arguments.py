...
def _add_transformer_engine_args(parser):
    ...
    group.add_argument('--lora-rank', default=0, type=int,
                       help='Number of ranks for Lora')
    group.add_argument('--lora-alpha', default=0, type=float, 
                       help='Alpha for Lora')
    return parser
...
def _add_training_args(parser):
    ...
    group.add_argument('--profile-step-end', type=int, default=13,
    ...
    group.add_argument('--profile-ranks', nargs='+', type=int, default=[0,1,2,3,4,5,6,7],
